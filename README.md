...
- Graphs open at a readable 100% scale. Use the scrollbars, a trackpad, or Shift+wheel to move through an oversized graph. Use **+**, **−**, and **Fit** for zoom; **Hand** provides drag-to-scroll navigation and can be disabled to resume node dragging.
